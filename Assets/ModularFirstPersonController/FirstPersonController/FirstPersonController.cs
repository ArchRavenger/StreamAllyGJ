...
public class FirstPersonController : MonoBehaviour
{
    ...
    [SerializeField] private bool underwaterMode = true;
    ...
    {
        {
            ...
            {
                UnderwaterMovement();
                return; // zruší pôvodný walking/sprint systém
            }

        }
        // PRE CHÔDZU (tvoja pôvodná logika)
        #region Movement
    ...
    private void UnderwaterMovement()
    {
        ...
        Vector3 move = (transform.right * horizontal + transform.forward * vertical) * swimSpeed;
